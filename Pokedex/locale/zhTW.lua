local L = LibStub("AceLocale-3.0"):NewLocale("MyAddon", "zhTW")
...
L["%s, I choose you!"] = "%s,我選擇你!" -- Needs review
...
L["Companions"] = "夥伴"
L["Dismiss Companion"] = "解散夥伴" -- Needs review
L["Dismiss Mount"] = "解散坐騎" -- Needs review
